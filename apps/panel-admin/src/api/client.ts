...
export const api = {
  ...
  marketing: {
    ...
    createSegmentFromEvent: (organizationId: string, data: any) => apiFetch<any>(`/organizations/${organizationId}/marketing/segments/from-event`, { method: "POST", body: JSON.stringify(data) }),
